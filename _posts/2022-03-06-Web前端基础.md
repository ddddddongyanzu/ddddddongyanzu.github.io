...
![3 (1)](/Users/dongyanzu/Desktop/3 (1).png)
...
但仅仅这样写，我们在页面上是看不到这个矩形的，因为我们还没有给他着色，而div默认是不填充颜色的。
...
![Screen Shot 2022-05-03 at 7.57.50 PM](/Users/dongyanzu/Library/Application Support/typora-user-images/Screen Shot 2022-05-03 at 7.57.50 PM.png)
...
在这个代码演示中，我们可以通过这一段代码看出，其实margin的设置方式和padding是一样的，可以得出margin的书写方式：
...
![1 (2)](/Users/dongyanzu/Desktop/1 (2).png)
...
![1](/Users/dongyanzu/Desktop/1.jpeg)
...
![2](/Users/dongyanzu/Desktop/2.jpeg)
...
![1 (1)](/Users/dongyanzu/Desktop/1 (1).jpeg)

在图中于`relative`相比较

1. 文档第一张下面的所有DOm元素，自动往上移动占据了第一张图片的位置，文档流（布局）一句没有为第一张图片预留空间了

2. 第一章图片脱离了文档流，变成了第二个图层，再在新的图层中往右下便宜50px；
3. 在MDN中，官方描述为：
...
![2 (1)](/Users/dongyanzu/Desktop/2 (1).jpeg)

我们会发现第一章图片相对于`<div class="img-box">`进行了偏移，而不是之前的`body`元素。
...
![6 (1)](/Users/dongyanzu/Desktop/6 (1).png)
...
![2 (2)](/Users/dongyanzu/Desktop/2 (2).jpeg)
...
我们先来看一下sticky是什么效果，为了方便演示效果，我们在会

标签的头上加了一个头图。

注意MOUNTAIN的效果，在它滚动道顶部时，黏在了顶部。而当页面开始往下面滚动时，MOUNTAIN又会恢复其在文档中的位置，这种效果就是sticky的效果，我们看下代码
...
这个布局时position的新特性，sticky中文叫做粘性，因此这种布局，我们叫做粘性布局。

在很多网站都有sticky效果，我们来看几个实际场景，大家可以实际滚动页面，观察高亮元素的位置。

[淘宝网](https://www.taobao.com/)	[知乎](https://www.zhihu.com/)	[苹果](https://www.apple.com.cn/macbook-pro/)
...
![4 (1)](/Users/dongyanzu/Desktop/4 (1).jpg)
...
![5](/Users/dongyanzu/Desktop/5.png)
...
![3 (1)](/Users/dongyanzu/Desktop/3 (1).jpg)
...
![2 (1)](/Users/dongyanzu/Desktop/2 (1).jpg)
...
1. [QQ快捷登录](http://im.qq.com/)

2. [微博登录](https://weibo.com/u/7410624782/home?wvr=5&sudaref=learn.youkeda.com)
3. [知乎删除操作](https://zhuanlan.zhihu.com/drafts)
...
![4](/Users/dongyanzu/Desktop/4.png)
...
![img](https://document.youkeda.com/P3-1-HTML-CSS/1.9/combat-1-modal/5.png?x-oss-process=image/resize,w_800/watermark,image_d2F0ZXJtYXNrLnBuZz94LW9zcy1wcm9jZXNzPWltYWdlL3Jlc2l6ZSx3XzEwMA==,t_60,g_se,x_10,y_10)

##### 第二步：完成模态框内部

我们先来看看内部元素的标注

![img](https://document.youkeda.com/P3-1-HTML-CSS/1.9/combat-1-modal/6.png?x-oss-process=image/resize,w_800/watermark,image_d2F0ZXJtYXNrLnBuZz94LW9zcy1wcm9jZXNzPWltYWdlL3Jlc2l6ZSx3XzEwMA==,t_60,g_se,x_10,y_10)
...
![img](https://document.youkeda.com/P3-1-HTML-CSS/1.9/combat-1-modal/7.png?x-oss-process=image/resize,w_800/watermark,image_d2F0ZXJtYXNrLnBuZz94LW9zcy1wcm9jZXNzPWltYWdlL3Jlc2l6ZSx3XzEwMA==,t_60,g_se,x_10,y_10)
...
![1 (3)](/Users/dongyanzu/Desktop/1 (3).png)
...
![2](/Users/dongyanzu/Desktop/2.png)
...
![img](https://document.youkeda.com/P3-1-HTML-CSS/1.9/combat-2-search/3.png?x-oss-process=image/resize,w_800/watermark,image_d2F0ZXJtYXNrLnBuZz94LW9zcy1wcm9jZXNzPWltYWdlL3Jlc2l6ZSx3XzEwMA==,t_60,g_se,x_10,y_10)
...
![4 (1)](/Users/dongyanzu/Desktop/4 (1).png)
...
![3 (2)](/Users/dongyanzu/Desktop/3 (2).png)
...
![4 (2)](/Users/dongyanzu/Desktop/4 (2).png)
...
![1 (4)](/Users/dongyanzu/Desktop/1 (4).png)

2. 微博的个人主页【https://weibo.com/u/1350995007】头部区域和整个页面背景。

![2 (1)](/Users/dongyanzu/Desktop/2 (1).png)

3. 网易云音乐【https://music.163.com/】

![3 (3)](/Users/dongyanzu/Desktop/3 (3).png)

##### 基础使用

我们现在来学习背景图片的使用方法，先看看我们的目标，实现如下简单的效果。

![4 (3)](/Users/dongyanzu/Desktop/4 (3).png)
...
![6 (2)](/Users/dongyanzu/Desktop/6 (2).png)
...
![8 (1)](/Users/dongyanzu/Desktop/8 (1).png)
...
![10 (1)](/Users/dongyanzu/Desktop/10 (1).png)
