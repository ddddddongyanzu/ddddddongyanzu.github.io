...
![语言](https://style.youkeda.com/img/ham/course/j1/j1-1/javacompile.svg)
...
![img](https://style.youkeda.com/img/ham/course/j1/j1-1/HelloWorld.png?x-oss-process=image/resize,w_1024/watermark,image_d2F0ZXJtYXNrLnBuZz94LW9zcy1wcm9jZXNzPWltYWdlL3Jlc2l6ZSx3XzEwMA==,t_60,g_se,x_10,y_10)
...
2. 在正确的目录下创建`src/main/java`
   ...
   ![img](https://style.youkeda.com/img/course/j200/java-muti.png)
   ...
   现在我们说一下包名的规则，一般来说包名的开始是一个公司或者一个组织的域名的反写，如果是个人也可以遵守类似的规则，举个例子，优课达的域名是 `baidu.com`,那么包名的起始就是`com.baidu`,我们就需要创建`com/baidu`这样的两级目录。Java 的规范建议是用包管理代码
...
![Screen Shot 2022-05-01 at 9.20.16 AM](/Users/dongyanzu/Library/Application Support/typora-user-images/Screen Shot 2022-05-01 at 9.20.16 AM.png)
...
![text-field.png](https://qgt-style.oss-cn-hangzhou.aliyuncs.com/img/course/j200/text-field.png)
...
![img](https://qgt-style.oss-cn-hangzhou.aliyuncs.com/img/course/j200/ordered-layout.png)
...
![img](https://qgt-style.oss-cn-hangzhou.aliyuncs.com/img/course/j200/ArrayList.png)
